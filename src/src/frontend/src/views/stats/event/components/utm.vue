...
let source: Ref<GetEventUsersGroupedByStat[] | undefined> = ref();
let medium: Ref<GetEventUsersGroupedByStat[] | undefined> = ref();
let campaign: Ref<GetEventUsersGroupedByStat[] | undefined> = ref();
let term: Ref<GetEventUsersGroupedByStat[] | undefined> = ref();
let content: Ref<GetEventUsersGroupedByStat[] | undefined> = ref();
...
async function loadData(groupBy: "utm_source" | "utm_medium" | "utm_campaign" | "utm_term" | "utm_content",
                        loading: Ref<boolean>,
                        data: Ref<GetEventUsersGroupedByStat[] | undefined>)
{
