...
import {GetUsersGroupedByStat} from "@backend/api-front/routes/stats/page";
...
let source: Ref<GetUsersGroupedByStat[] | undefined> = ref();
let medium: Ref<GetUsersGroupedByStat[] | undefined> = ref();
let campaign: Ref<GetUsersGroupedByStat[] | undefined> = ref();
let term: Ref<GetUsersGroupedByStat[] | undefined> = ref();
let content: Ref<GetUsersGroupedByStat[] | undefined> = ref();
